...
On cloning or downloading the repository, try running 'pip install -e .' in the directory. This should make an executable in the python Scripts folder which can be run from the command line as 'pdfgetx3gui' from any directory.
